    ...
    <v-container class="pa-0 pb-5">
        <v-layout wrap align-center justify-center row fill-height>
            ...
            <v-flex xs12 md12 class="mt-3">
                ...
                <p class="google-font my-2" style="font-size:110%">Apoiadores</p>
                    ...
                    <v-flex xs12 sm7 class="elevation-0 transparent">
                        <v-card class="elevation-0 pa-0 ma-0 transparent">
                            <v-container grid-list-sm fluid class="pa-0 ma-0">
                                <v-layout row wrap class="ma-0 pa-0">
                                    <v-flex
                                        v-for="(itemp,i) in supporterData" :key="i"
                                        xs6
                                        md3
                                        sm4
                                        d-flex
            ...
            <v-flex xs12 md12 class="mt-3">
                <p class="google-font my-2" style="font-size:110%">Parceiro de Template</p>
...
import datas from '@/assets/data/supporters.json'
